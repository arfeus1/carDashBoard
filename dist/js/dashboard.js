window.onload = function() {
    ...
    attention.onclick = function() {
        if (attention.style.visibility = "visible") {
            attention.style.visibility = "hidden";
            attention.style.transform = "translateX(-600px)";
        }
    }

    credits.onclick = function() {
        if (attention.style.visibility = "hidden") {
            attention.style.visibility = "visible";
            attention.style.transform = "translateX(0px)";
        }
    }
